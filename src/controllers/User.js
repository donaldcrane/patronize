...
const {
  emailExist, usernameExist, createUser, updateUserProfile,
  getAllUsers, updateUserProfilePicture, getUser
} = User;
/**
...
export default class UserController {
  ...
  static async getUserById(req, res) {
    try {
      ...
      return res.status(200).json({ status: 200, message: "Successfully retrived User", data: user });
    } catch (error) {
      return res.status(500).json({ status: 500, error: "Resource not found." });
    }
  }
